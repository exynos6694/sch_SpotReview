  ...
  const mobileSheet = (
    <div className="md:hidden fixed inset-0 z-20 pointer-events-none">
      ...
      <div
        ...
        style={{ opacity: sheetHeight * 0.5, background: "rgba(0,0,0,1)" }}
        onClick={handleClose}
      />
      ...
      <div
        ref={sheetRef}
        className="absolute left-0 right-0 bottom-0 pointer-events-auto bg-white rounded-t-3xl shadow-2xl flex flex-col"
        style={{
      ...
      >
        ...
        {/* Restaurant info (always visible at half) */}
        ...
        {/* Divider */}
        {isExpanded && <div className="border-t border-gray-100 mx-5" />}

        {/* Reviews section (visible when expanded) */}
        <div
          ref={contentRef}
